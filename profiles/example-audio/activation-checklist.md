...
- [ ] `assets/`: logos e imagenes con rutas `/images/example-audio/...`.
...
```env
NEXT_PUBLIC_B2B_CLIENT_PROFILE=example-audio
```
...
```env
B2B_CLIENT_PROFILE=example-audio
```
...
- [ ] Vercel storefront: `NEXT_PUBLIC_B2B_CLIENT_PROFILE=example-audio`.
- [ ] Render backend: `B2B_CLIENT_PROFILE=example-audio`.
