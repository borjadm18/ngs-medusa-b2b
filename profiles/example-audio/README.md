...
- `assets/`: logos e imagenes que se publicaran como `/images/example-audio/...`.
...
NEXT_PUBLIC_B2B_CLIENT_PROFILE=example-audio pnpm --filter @b2b-starter/storefront build
```

Para produccion, configura `NEXT_PUBLIC_B2B_CLIENT_PROFILE=example-audio` en Vercel y `B2B_CLIENT_PROFILE=example-audio` en Render si quieres sembrar packaging de este perfil.
